...
## Map Projection #4
### For the purposes of the next few examples, I will use the projection of the US using the Albers Equal Area projection.
...
ggplot(US_data, aes(fill = estimate/1000000)) +
  geom_sf()+
  scale_fill_viridis_c(name = "Total population (M)",
